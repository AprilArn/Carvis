...
//    private const val MAX_NO_DETECTION_DURATION = 500 // ms
//
//    data class Line(val start: Point, val end: Point)
//
//    fun detectLaneWithLines(bitmap: Bitmap): Pair<Bitmap, List<Pair<Point, Point>>> {
//        val mat = Mat()
...
//        }
//
//        val linePairs = previousLines?.map { it.start to it.end } ?: emptyList()
//
//        // Optional: draw lines directly on the bitmap (if you want to save or preview)
//        val overlay = mat.clone()
//        drawLines(overlay, previousLines)
//
//        val resultBitmap = Bitmap.createBitmap(overlay.cols(), overlay.rows(), Bitmap.Config.ARGB_8888)
//        Utils.matToBitmap(overlay, resultBitmap)
//        return Pair(resultBitmap, linePairs)
//    }
//
...
//            Point(0.575 * width, 0.55 * height),
//            Point(0.425 * width, 0.55 * height)
//        )
...
//    }
//
//    private fun lerpLines(oldLines: List<Line>?, newLines: List<Line>, alpha: Double = 0.2): List<Line> {
...
//    }
//
//    private fun drawLines(mat: Mat, lines: List<Line>?) {
//        if (lines == null) return
//        for (line in lines) {
//            Imgproc.line(mat, line.start, line.end, Scalar(255.0, 255.0, 0.0), 3)
//        }
//    }
//}
